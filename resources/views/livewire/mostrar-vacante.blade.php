<div class="p-10">
    ...
    <div class="md:grid md:grid-cols-6 gap-4"> <!-- Se divide en 6 columnas -->
        <div class="md:col-span-2"> <!-- Toma dos columnas -->
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                ¿Deseas postularte a esta vacante? <a class="font-bold text-indigo-600" href="{{ route('register') }}">Obten una cuenta y aplica a esta y otras vacantes</a>
            </p>
        </div>
    @endguest
</div>
